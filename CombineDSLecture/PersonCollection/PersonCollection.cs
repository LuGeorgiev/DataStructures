...
public class PersonCollection : IPersonCollection
{
    ...
    public bool AddPerson(string email, string name, int age, string town)
    {
        ...
        this.AddByNameAndTown(email, person);
    ...
    private void AddByAge(Person person)
    {
        ...
        this.byAge[age].Add(mail, person);
    }

    private void AddByNameAndTown(string email, Person person)
    {
        ...
        this.byNameAndTown[key].Add(email, person);
    }
    ...
    {
        //return this.byEmail.FirstOrDefault(x => x.Key == email).Value;
